...
# 🧭 Ariane — Save & Restore Your Flow State

Ariane is a premium Chrome extension designed to eliminate context-switching fatigue. Instead of just bookmarking tabs, Ariane captures your exact "flow state" so you can freeze a session and resume it later precisely where you left off, complete with an AI-generated briefing of your tasks.
...
## 🙋‍♂️ Feedback & Support
This repository is the official support hub for Ariane.
*   **Report a bug / Suggest a feature:** Please [Open an Issue](https://github.com/mavinee/ariane-feedback/issues).
*   **Privacy Policy:** Read our official [Privacy Policy](./PRIVACY_POLICY.md) (also available [here](https://mavinee.github.io/ariane-feedback/PRIVACY_POLICY.html)).
*   **Contact:** You can reach us directly at [ariane.extension@gmail.com](mailto:ariane.extension@gmail.com).
